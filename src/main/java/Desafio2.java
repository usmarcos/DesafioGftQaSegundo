...
//    Desafio: Domingo é dia de feira. Logo de manhã muitas pessoas se deslocam para o polo de lazer da Parangaba, onde acontece uma feira, conhecida por ser a maior da cidade. Na feira da Parangaba você pode encontrar de tudo.
        ...
        while (leitor.hasNext()) {
          ...
          /*  switch (hora) {
                case (7):
                    ...
                    break;
                case (8):
                    System.out.println("Atraso maximo: " + 60 * (hora - 8) + min);
                    break;
                case (9):
                    System.out.println("Atraso maximo: " + 60 * (hora - 9) + min);
                    break;
                default:
